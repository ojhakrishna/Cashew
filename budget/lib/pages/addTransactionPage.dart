...
import 'package:budget/widgets/accountAndBackup.dart'
    show googleUser, signInGoogle, GoogleAuthClient;
...
class _AddTransactionPageState extends State<AddTransactionPage>
  ...
  Transaction createTransaction({bool removeShared = false}) {
    ...
    //     : selectedType == null; // Unused variable removed
    ...
    if (selectedType != null &&
      ...
      if ([
        ...
        // paid = true; // Removed unused variable
        skipPaid = false;
      } else {
        // paid = false; // Removed unused variable
        skipPaid = false;
      }
    }
      ...
      outsideExtraWidget: customDateTimeSelected
          ...
          : OutsideExtraWidgetIconButton(
              ...
              onPressed: () async {
                ...
                setState(() {
                  customDateTimeSelected = true;
                  selectedDateTime = dateTimeSelected ?? selectedDateTime;
                });
